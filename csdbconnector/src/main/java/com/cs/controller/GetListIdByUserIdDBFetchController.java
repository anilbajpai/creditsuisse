...
@RequestMapping("/GetListIdByUserIdDBFetchController")

@Api(basePath = "/GetListIdByUserIdDBFetchController", value = "GetListIdByUserIdDBFetchController", description = "Operations with Db", produces = "application/json")
@RestController
public class GetListIdByUserIdDBFetchController {
	char ch = '"';
