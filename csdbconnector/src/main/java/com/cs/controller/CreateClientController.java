...
@Api(basePath = "/CreateClient", value = "CreateClient", description = "Operations with Db", produces = "application/json")
@RestController
public class CreateClientController {
	...
	public @ResponseBody String saveChangesPost(
			@RequestBody(required = true) ClientMaster insertRequest) {
		SqlSession sqlSession = MyBatisSqlSessionFactory.getSqlSessionFactory().openSession();
		try {
			MybatisAbstractDao<ClientMaster, Serializable, BaseEntityExample> dao = new MybatisAbstractDao<ClientMaster, Serializable, BaseEntityExample>();
