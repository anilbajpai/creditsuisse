...
@RequestMapping("/CreateExecution")

@Api(basePath = "/CreateExecution", value = "CreateExecution", description = "Operations with Db", produces = "application/json")
@RestController
public class CreateExecutionController {
	...
	public @ResponseBody String saveChangesPost(
			@RequestBody(required = true) ExecutionMst insertRequest) {
